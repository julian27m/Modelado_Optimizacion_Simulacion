%   Entrega 3 del proyecto: Movilidad en la Universidad de los Andes
...
origen='ML5';
destino='W6';
[sp, spcost] = entrega3_dijkstra(t, origen, destino)  %sp: shortest path, spcost: shortest path cost